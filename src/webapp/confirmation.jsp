...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>PH441 | Confirmation</title>
...
<section class="page-wrapper success-msg">
  <div class="container">
    <div class="block text-center">
      <i class="tf-ion-ios-checkmark-empty" style="background-color: #1F0D40" ></i>
    </div>
    <br>
    <div class="row">
      <div class="col-md-12">
        <div class="container">
          <div class="container" style=" z-index: 100;position: relative; background-color: #1F0D40; width: 40%;
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="content">
                  <%String contactsent1 = grabText.getTextById(26).getText();%>
          ...
          <div class="container" style=" min-width: 15vw; position: relative; width: 100%;
            ...
            <div class="row">
              <div class="col-md-12" style="border: transparent 10vh solid;">
                <%String contactsent2 = grabText.getTextById(27).getText();%>
        ...
        <br>
          <div class="block text-center">
            ...
            <div class="col-md-3">
          <a href="questions.jsp" class="btn btn-main mt-20" >Submit A Question</a>
            </div>
            <div class="col-md-3">
