...
<%@ page import="com.picturehouse.picturehouse441.models.newsmodel" %>
<!DOCTYPE html>
...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>PH441 | Newsletter Options</title>
...
<section class="page-wrapper" style="background-color: #fff4e9">
    <div class="contact-section">
        <div class="container">
            <div class="row">
                <!-- Contact Form -->
                <h3 style="text-align: center">SEND NEWSLETTER</h3>
                <br>
                ...
                <div class="contact-form">
                    <form id="contact-form" method="post" action="SendNewsEmail" role="form">
...
<div style="width: 75%; margin-left: auto; margin-right: auto">
    <table class="table table-hover table-dark" border="1">
        ...
        <% newsdao pd = new newsdao();
            List<newsmodel> products = pd.getNews();
            if(!products.isEmpty()){
                //Collections.reverse(products);
                for(newsmodel p : products){
                    int id = p.getId();
        ...
        <tr>
            <td><%= id%></td>
            <td><%= name%></td>
            <td><a class="btn btn-white btn-outline-white" onclick="deleteConfirm()" href="deleteSub?id=<%= id%>">Delete Subscriber</a></td>
